...
public class StringUtil {
    ...
    public static int indexOfDifference(String str1, String str2) {
        if ((str1 == null) || (str2 == null) || str1.equals(str2)) {//modify by linb ,v1.2.7.1 ,at 2017-08-08:修复字符str1==str2比较bug
            return -1;
        }
     ...
     * @author linbo v1.2.6
     */
	public static boolean regexChinessLetterNum(String str) {
		boolean flag = false;
	 ...
	 * @author linbo v1.2.6
	 */
	public static boolean regexLetterNum(String str) {
		boolean flag = false;
	...
	/**
	 * 日期格式检查，只能为yyyy-MM-dd格式
	 * @param str
	 * @return
	 * @author linbo v1.2.6 2017-0-802
	 */
	public static boolean regexDateYMD(String str) {
		boolean flag = false;
